...
export type RichTextInlineElementFragment = { __typename?: 'OlapChartLayer' } & Pick<
  OlapChartLayer,
  'chartType' | 'cubeId' | 'width' | 'height' | 'positionX' | 'positionY'
> & {
    columns: Maybe<Array<{ __typename?: 'OlapRequestField' } & OlapRequestFieldFragment>>
    rows: Maybe<Array<{ __typename?: 'OlapRequestField' } & OlapRequestFieldFragment>>
    whereFilters: Maybe<Array<{ __typename?: 'FormulaToken' } & FormulaTokenFragment>>
    havingFilters: Maybe<Array<{ __typename?: 'FormulaToken' } & FormulaTokenFragment>>
  }

export type FormulaTokenRecursiveFragment = { __typename?: 'FormulaToken' } & Pick<
  FormulaToken,
  'tokenType' | 'value'
> & {
    dataValue: Maybe<
      { __typename?: 'DataValue' } & Pick<DataValue, 'columnId' | 'fieldId' | 'dataTableFieldId'>
    >
    listValue: Maybe<{ __typename?: 'ListValue' } & Pick<ListValue, 'list' | 'title'>>
  }

export type FuncValueFragment = { __typename?: 'FuncValue' } & Pick<FuncValue, 'name'> & {
    args: Array<
      Array<
        { __typename?: 'FormulaToken' } & {
          funcValue: Maybe<
            { __typename?: 'FuncValue' } & Pick<FuncValue, 'name'> & {
                args: Array<Array<{ __typename?: 'FormulaToken' } & FormulaTokenRecursiveFragment>>
              }
          >
...
export type FormulaTokenFragment = { __typename?: 'FormulaToken' } & {
  funcValue: Maybe<{ __typename?: 'FuncValue' } & FuncValueFragment>
} & FormulaTokenRecursiveFragment

export type FolderMainInfoFragment = { __typename?: 'Folder' } & Pick<
  Folder,
  'id' | 'title' | 'isOpened' | 'isLocked' | 'sharedAccess' | 'sharedToken' | 'asOwner'
> & {
    invitedUsers: Maybe<Array<{ __typename?: 'User' } & UserFragment>>
    usersAccessList: Maybe<Array<{ __typename?: 'User' } & UserFragment>>
    groupAccessList: Maybe<Array<{ __typename?: 'UserGroup' } & UserGroupFragment>>
    objects: Array<{ __typename?: 'Object' } & ObjectFragment>
    defaultPanels: Array<{ __typename?: 'DefaultPanel' } & Pick<DefaultPanel, 'panelId' | 'userId'>>
  }

export type FolderFragment = { __typename?: 'Folder' } & {
  folders: Array<
    { __typename?: 'Folder' } & {
      folders: Array<
        { __typename?: 'Folder' } & {
          folders: Array<
            { __typename?: 'Folder' } & {
              folders: Array<
                { __typename?: 'Folder' } & {
                  folders: Array<{ __typename?: 'Folder' } & FolderMainInfoFragment>
...
export type ColumnShortFragment = { __typename?: 'Column' } & Pick<
  Column,
  'id' | 'title' | 'originalTitle' | 'include'
>

export type StepShortFragment = { __typename?: 'Step' } & Pick<
  Step,
  | 'id'
  | 'leftStepId'
  | 'positionX'
...
export type RootFoldersFragment = { __typename?: 'Trees' } & {
  tree: { __typename?: 'Tree' } & {
    folders: Array<
      { __typename?: 'Folder' } & Pick<Folder, 'id' | 'title'> & {
          defaultPanels: Array<
            { __typename?: 'DefaultPanel' } & Pick<DefaultPanel, 'userId' | 'panelId'>
          >
        }
    >
  }
...
export type AclFragment = { __typename?: 'Acl' } & {
  etl: { __typename?: 'EtlAcl' } & EtlAclFragment
  olap: { __typename?: 'OlapAcl' } & OlapAclFragment
  ose: { __typename?: 'OseAcl' } & OseAclFragment
  shared: { __typename?: 'SharedAcl' } & SharedAclFragment
}

export type AdditionalCalcFragment = { __typename?: 'AdditionalCalc' } & Pick<
  AdditionalCalc,
  'cumulativeTotal' | 'groupBy' | 'growth' | 'growthRate' | 'linkedFieldId' | 'percentOfTotal'
>

export type AnalysisFragment = { __typename?: 'Analysis' } & {
  regression: Maybe<{ __typename?: 'Regression' } & RegressionFragment>
}

export type AttachmentFragment = { __typename?: 'Attachment' } & Pick<
  Attachment,
  'aspectRatio' | 'contentType' | 'id' | 'name' | 'url'
>

export type AutocompleteFragment = { __typename?: 'Autocomplete' } & Pick<
  Autocomplete,
  'name' | 'type'
> & {
    column: Maybe<{ __typename?: 'Column' } & ColumnFragment>
    function: Maybe<{ __typename?: 'Function' } & FunctionFragment>
  }

export type ChangeFragment = { __typename?: 'Change' } & Pick<
  Change,
  'after' | 'before' | 'changeType' | 'id' | 'insertedAt'
> & { column: { __typename?: 'Column' } & ColumnFragment }

export type ChatAvatarFragment = { __typename?: 'ChatAvatar' } & Pick<ChatAvatar, 'large' | 'small'>

export type ChatMessageFragment = { __typename?: 'ChatMessage' } & Pick<
  ChatMessage,
  'embed' | 'messageId' | 'replyId' | 'roomId' | 'text' | 'userId'
> & {
    reply: Maybe<{ __typename?: 'ChatMessage' } & Pick<ChatMessage, 'messageId'>>
    user: Maybe<{ __typename?: 'ChatUser' } & ChatUserFragment>
  }

export type ChatOnlineFragment = { __typename?: 'ChatOnline' } & Pick<ChatOnline, 'id'> & {
    meta: Maybe<{ __typename?: 'ChatOnlineMeta' } & ChatOnlineMetaFragment>
  }

export type ChatOnlineMetaFragment = { __typename?: 'ChatOnlineMeta' } & Pick<
  ChatOnlineMeta,
  'onlineAt'
>

export type ChatRoomFragment = { __typename?: 'ChatRoom' } & Pick<
  ChatRoom,
  'dialog' | 'messageId' | 'metadata' | 'name' | 'roomId' | 'updatedAt'
> & {
    lastMessage: Maybe<{ __typename?: 'ChatMessage' } & ChatMessageFragment>
    user: Maybe<{ __typename?: 'ChatUser' } & ChatUserFragment>
  }

export type ChatUserFragment = { __typename?: 'ChatUser' } & Pick<ChatUser, 'id' | 'name'> & {
    avatar: Maybe<{ __typename?: 'ChatAvatar' } & ChatAvatarFragment>
  }

export type CodecFragment = { __typename?: 'Codec' } & Pick<Codec, 'level' | 'type'>
...
> & {
    changes: Maybe<
      Array<{ __typename?: 'Change' } & Pick<Change, 'after' | 'before' | 'changeType' | 'id'>>
    >
    codecs: Maybe<Array<{ __typename?: 'Codec' } & CodecFragment>>
    columnStats: Maybe<Array<{ __typename?: 'ColumnStat' } & ColumnStatFragment>>
    step: { __typename?: 'Step' } & Pick<Step, 'id'>
  }

export type ColumnStatFragment = { __typename?: 'ColumnStat' } & Pick<ColumnStat, 'count' | 'value'>

export type ConnectedEntitiesFragment = { __typename?: 'ConnectedEntities' } & Pick<
  ConnectedEntities,
  'folders' | 'objects'
>

export type ConnectionFragment = { __typename?: 'Connection' } & Pick<
  Connection,
  'id' | 'joinType' | 'leftTableFieldId' | 'leftTableId' | 'rightTableFieldId' | 'rightTableId'
>

export type CoordsFragment = { __typename?: 'Coords' } & Pick<
  Coords,
  'coordsType' | 'lineCoords' | 'pointCoords' | 'polyCoords'
>

export type CubeFilterFragment = { __typename?: 'CubeFilter' } & Pick<
  CubeFilter,
  'cubeId' | 'cubeTitle' | 'draftInput'
> & { filter: Array<{ __typename?: 'FormulaToken' } & FormulaTokenFragment> }

export type DashboardAnalysisFragment = { __typename?: 'DashboardAnalysis' } & {
  regression: Maybe<{ __typename?: 'DashboardRegression' } & DashboardRegressionFragment>
}

export type DashboardRegressionFragment = { __typename?: 'DashboardRegression' } & Pick<
  DashboardRegression,
  'predictSize'
> & { models: Maybe<Array<{ __typename?: 'RegressionModelV1' } & RegressionModelV1Fragment>> }

export type DataTableFragment = { __typename?: 'DataTable' } & Pick<
  DataTable,
  | 'description'
  | 'errorCount'
  | 'id'
  ...
  | 'updatedAt'
> & {
    fields: Array<{ __typename?: 'DataTableField' } & DataTableFieldFragment>
    mapLayerStyles: Maybe<{ __typename?: 'MapLayerStyles' } & MapLayerStylesFragment>
    object: Maybe<{ __typename?: 'Object' } & ObjectFragment>
    tooltip: Maybe<{ __typename?: 'MapLayerTooltip' } & MapLayerTooltipFragment>
  }

export type DataTableFieldFragment = { __typename?: 'DataTableField' } & Pick<
  DataTableField,
  | 'considerSearch'
  | 'dataTableId'
  | 'defaultValue'
...
> & {
    validation: Maybe<
      { __typename?: 'DataTableFieldValidation' } & DataTableFieldValidationFragment
    >
  }

export type DataTableFieldValidationFragment = { __typename?: 'DataTableFieldValidation' } & Pick<
...
export type DataTableRowFragment = { __typename?: 'DataTableRow' } & Pick<
  DataTableRow,
  'createdAt' | 'id'
> & { fields: Array<{ __typename?: 'DataTableRowField' } & DataTableRowFieldFragment> }

export type DataTableRowFieldFragment = { __typename?: 'DataTableRowField' } & Pick<
  DataTableRowField,
  | 'catalogValue'
  | 'dataTableFieldId'
  | 'dateValue'
  ...
  | 'validationErrors'
> & {
    coordinatesValue: Maybe<{ __typename?: 'Coords' } & CoordsFragment>
    fileValue: Maybe<Array<{ __typename?: 'Attachment' } & AttachmentFragment>>
  }

export type DataValueFragment = { __typename?: 'DataValue' } & Pick<
  DataValue,
  'agg' | 'columnId' | 'dataTableFieldId' | 'fieldId' | 'groupFieldId' | 'tableId' | 'title'
> & { filter: Maybe<Array<{ __typename?: 'FormulaToken' } & FormulaTokenFragment>> }

export type DatasourceFragment = { __typename?: 'Datasource' } & Pick<
  Datasource,
  'id' | 'periodicityType' | 'periodicityValue' | 'sourceType' | 'title'
> & {
    datasourceProgresses: Maybe<
      Array<{ __typename?: 'DatasourceProgress' } & DatasourceProgressFragment>
    >
    datasourceState: Maybe<{ __typename?: 'DatasourceState' } & DatasourceStateFragment>
    dbParams: Maybe<{ __typename?: 'DbParams' } & DbParamsFragment>
    eisParams: Maybe<{ __typename?: 'EisParams' } & EisParamsFragment>
    ftpParams: Maybe<{ __typename?: 'FtpParams' } & FtpParamsFragment>
    object: { __typename?: 'Object' } & ObjectFragment
    odataParams: Maybe<{ __typename?: 'OdataParams' } & OdataParamsFragment>
    restParams: Maybe<{ __typename?: 'RestParams' } & RestParamsFragment>
    steps: Array<{ __typename?: 'Step' } & Pick<Step, 'id' | 'title'>>
  }

export type DatasourceProgressFragment = { __typename?: 'DatasourceProgress' } & Pick<
  DatasourceProgress,
  | 'allCount'
  | 'datasourceId'
  | 'doneCount'
  ...
  | 'stopDate'
  | 'tableId'
> & { processes: Maybe<Array<{ __typename?: 'Progress' } & ProgressFragment>> }

export type DatasourceStateFragment = { __typename?: 'DatasourceState' } & Pick<
  DatasourceState,
  'allCount' | 'currentSubsource' | 'datasourceId' | 'doneCount'
>

export type DbParamsFragment = { __typename?: 'DbParams' } & Pick<
  DbParams,
  'db' | 'dbType' | 'host' | 'pass' | 'port' | 'user'
> & { tables: Maybe<Array<{ __typename?: 'DbTable' } & DbTableFragment>> }

export type DbTableFragment = { __typename?: 'DbTable' } & Pick<DbTable, 'id' | 'name' | 'schema'>

export type DefaultPanelFragment = { __typename?: 'DefaultPanel' } & Pick<
  DefaultPanel,
  'panelId' | 'userId'
>

export type EisDirFragment = { __typename?: 'EisDir' } & Pick<
  EisDir,
  'id' | 'includeSubdirs' | 'path' | 'queries' | 'regexp' | 'title'
>

export type EisParamsFragment = { __typename?: 'EisParams' } & Pick<
  EisParams,
  'host' | 'pass' | 'port' | 'user'
> & { dirs: Maybe<Array<{ __typename?: 'EisDir' } & EisDirFragment>> }

export type EntityCreatedFragment = { __typename?: 'EntityCreated' } & Pick<
  EntityCreated,
  'entity' | 'type'
>

export type EtlAclFragment = { __typename?: 'EtlAcl' } & Pick<
  EtlAcl,
  'datasourceEdit' | 'datasourceRead' | 'flowEdit' | 'flowRead'
>

export type ExternalSystemFragment = { __typename?: 'ExternalSystem' } & Pick<
  ExternalSystem,
  'folderId' | 'id' | 'ips' | 'title'
> & { params: Array<{ __typename?: 'ExternalSystemParams' } & ExternalSystemParamsFragment> }

export type ExternalSystemParamsFragment = { __typename?: 'ExternalSystemParams' } & Pick<
  ExternalSystemParams,
  'active' | 'description' | 'key' | 'value'
>
...
export type FlowFragment = { __typename?: 'Flow' } & Pick<
  Flow,
  'id' | 'insertedAt' | 'title' | 'updatedAt'
> & {
    acl: Maybe<{ __typename?: 'FlowAcl' } & FlowAclFragment>
    connectedEntities: { __typename?: 'ConnectedEntities' } & ConnectedEntitiesFragment
    object: { __typename?: 'Object' } & ObjectFragment
  }

export type FlowAclFragment = { __typename?: 'FlowAcl' } & Pick<
  FlowAcl,
  'copy' | 'delete' | 'update'
>

export type FtpDirFragment = { __typename?: 'FtpDir' } & Pick<
  FtpDir,
  'id' | 'includeSubdirs' | 'path' | 'regexp' | 'title'
>

export type FtpEnityFragment = { __typename?: 'FtpEnity' } & Pick<FtpEnity, 'name' | 'type'>

export type FtpParamsFragment = { __typename?: 'FtpParams' } & Pick<
  FtpParams,
  'host' | 'pass' | 'port' | 'user'
> & { dirs: Maybe<Array<{ __typename?: 'FtpDir' } & FtpDirFragment>> }

export type FunctionFragment = { __typename?: 'Function' } & Pick<
  Function,
  'arg1Type' | 'arg2Type' | 'arg3Type' | 'argsCount' | 'description' | 'name' | 'resultType'
> & { examples: Maybe<Array<{ __typename?: 'FunctionExample' } & FunctionExampleFragment>> }

export type FunctionExampleFragment = { __typename?: 'FunctionExample' } & Pick<
  FunctionExample,
  'formula' | 'result'
>

export type HierarchyFragment = { __typename?: 'Hierarchy' } & Pick<
  Hierarchy,
  | 'description'
  | 'id'
  | 'insertedAt'
  ...
  | 'title'
  | 'updatedAt'
> & { dims: Maybe<Array<{ __typename?: 'HierarchyDim' } & HierarchyDimFragment>> }

export type HierarchyDimFragment = { __typename?: 'HierarchyDim' } & Pick<
  HierarchyDim,
  'dimId' | 'position'
>

export type IndicatorFragment = { __typename?: 'Indicator' } & Pick<
  Indicator,
  | 'baseRating'
  | 'displayColumnIds'
  | 'displayFKeyId'
  ...
  | 'updatedAt'
> & {
    connectedEntities: Maybe<{ __typename?: 'ConnectedEntities' } & ConnectedEntitiesFragment>
    formula: Maybe<Array<{ __typename?: 'FormulaToken' } & FormulaTokenFragment>>
    object: Maybe<{ __typename?: 'Object' } & ObjectFragment>
  }

export type IndicatorsAutocompleteFragment = { __typename?: 'IndicatorsAutocomplete' } & Pick<
  IndicatorsAutocomplete,
  'name' | 'type'
> & {
    field: Maybe<{ __typename?: 'Field' } & FieldFragment>
    function: Maybe<{ __typename?: 'Function' } & FunctionFragment>
    table: Maybe<{ __typename?: 'Table' } & TableFragment>
  }

export type ListValueFragment = { __typename?: 'ListValue' } & Pick<ListValue, 'list' | 'title'>

export type MapFragment = { __typename?: 'Map' } & Pick<
  Map,
  | 'center'
  | 'id'
  | 'insertedAt'
  ...
  | 'zoom'
> & {
    layers: Maybe<Array<{ __typename?: 'MapLayer' } & MapLayerFragment>>
    object: Maybe<{ __typename?: 'Object' } & ObjectFragment>
  }

export type MapLayerFragment = { __typename?: 'MapLayer' } & Pick<
  MapLayer,
  'dataTableId' | 'id' | 'insertedAt' | 'mapId' | 'position' | 'title' | 'updatedAt' | 'visible'
> & {
    filter: Maybe<Array<{ __typename?: 'FormulaToken' } & FormulaTokenFragment>>
    mapLayerStyles: Maybe<{ __typename?: 'MapLayerStyles' } & MapLayerStylesFragment>
    modal: Maybe<{ __typename?: 'MapLayerModal' } & MapLayerModalFragment>
    tooltip: Maybe<{ __typename?: 'MapLayerTooltip' } & MapLayerTooltipFragment>
  }

export type MapLayerModalFragment = { __typename?: 'MapLayerModal' } & Pick<
  MapLayerModal,
  | 'backgroundColor'
  | 'borderColor'
  | 'borderType'
  ...
  | 'paddingRight'
  | 'paddingTop'
> & { blocks: Maybe<Array<{ __typename?: 'ModalBlock' } & ModalBlockFragment>> }

export type MapLayerRtxDataFragment = { __typename?: 'MapLayerRtxData' } & Pick<
  MapLayerRtxData,
  'align' | 'type'
> & { children: Array<{ __typename?: 'MapLayerRtxItem' } & MapLayerRtxItemFragment> }

export type MapLayerRtxItemFragment = { __typename?: 'MapLayerRtxItem' } & Pick<
  MapLayerRtxItem,
  | 'backgroundColor'
  | 'bold'
  | 'color'
  ...
  | 'type'
> & {
    children: Maybe<Array<{ __typename?: 'MapLayerRtxItemChild' } & MapLayerRtxItemChildFragment>>
  }

export type MapLayerRtxItemChildFragment = { __typename?: 'MapLayerRtxItemChild' } & Pick<
  MapLayerRtxItemChild,
  'text'
>

export type MapLayerSharedFragment = { __typename?: 'MapLayerShared' } & Pick<
  MapLayerShared,
  'id' | 'mapId' | 'position' | 'title' | 'visible'
> & {
    mapLayerStyles: Maybe<{ __typename?: 'MapLayerStyles' } & MapLayerStylesFragment>
    modal: Maybe<{ __typename?: 'MapLayerModal' } & MapLayerModalFragment>
    tooltip: Maybe<{ __typename?: 'MapLayerTooltip' } & MapLayerTooltipFragment>
...
export type MapLayerStylesFragment = { __typename?: 'MapLayerStyles' } & Pick<
  MapLayerStyles,
  'gridSize' | 'gridType' | 'showArrowLine'
> & {
    fillOptions: Maybe<
      { __typename?: 'MapLayerStylesFillOptions' } & MapLayerStylesFillOptionsFragment
    >
    sizeOptions: Maybe<
      { __typename?: 'MapLayerStylesSizeOptions' } & MapLayerStylesSizeOptionsFragment
    >
    stroke: Maybe<{ __typename?: 'MapLayerStylesStroke' } & MapLayerStylesStrokeFragment>
  }

export type MapLayerStylesFillOptionsFragment = { __typename?: 'MapLayerStylesFillOptions' } & Pick<
  MapLayerStylesFillOptions,
  'color' | 'fillType' | 'gridAggType' | 'opacity' | 'scalesDataFieldId' | 'showInLegend'
> & {
    scales: Maybe<
      Array<{ __typename?: 'MapLayerStylesFillScale' } & MapLayerStylesFillScaleFragment>
    >
  }

export type MapLayerStylesFillScaleFragment = { __typename?: 'MapLayerStylesFillScale' } & Pick<
  MapLayerStylesFillScale,
  'name' | 'scaleFunc' | 'scaleType' | 'showInLegend'
> & {
    limits: Maybe<
      Array<{ __typename?: 'MapLayerStylesFillScaleLimit' } & MapLayerStylesFillScaleLimitFragment>
    >
  }
...
export type MapLayerStylesSizeOptionsFragment = { __typename?: 'MapLayerStylesSizeOptions' } & Pick<
  MapLayerStylesSizeOptions,
  'gridAggType' | 'scalesDataFieldId' | 'size' | 'type'
> & {
    scales: Maybe<
      Array<{ __typename?: 'MapLayerStylesSizeScale' } & MapLayerStylesSizeScaleFragment>
    >
  }

export type MapLayerStylesSizeScaleFragment = { __typename?: 'MapLayerStylesSizeScale' } & Pick<
  MapLayerStylesSizeScale,
  'name' | 'scaleFunc' | 'scaleType' | 'showInLegend'
> & {
    limits: Maybe<
      Array<{ __typename?: 'MapLayerStylesSizeScaleLimit' } & MapLayerStylesSizeScaleLimitFragment>
    >
  }
...
export type MapLayerStylesStrokeFragment = { __typename?: 'MapLayerStylesStroke' } & Pick<
  MapLayerStylesStroke,
  'color' | 'opacity' | 'size'
>

export type MapLayerTooltipFragment = { __typename?: 'MapLayerTooltip' } & Pick<
  MapLayerTooltip,
  | 'backgroundColor'
  | 'borderColor'
  | 'borderRadius'
  ...
  | 'paddingRight'
  | 'paddingTop'
> & { rtx: Maybe<Array<{ __typename?: 'MapLayerRtxData' } & MapLayerRtxDataFragment>> }

export type MapSharedFragment = { __typename?: 'MapShared' } & Pick<
  MapShared,
  'center' | 'id' | 'tileLayerLink' | 'zoom'
> & { layers: Maybe<Array<{ __typename?: 'MapLayerShared' } & MapLayerSharedFragment>> }

export type ModalBlockFragment = { __typename?: 'ModalBlock' } & Pick<
  ModalBlock,
  | 'backgroundColor'
  | 'borderColor'
  | 'borderType'
  ...
  | 'type'
> & {
    embedLink: Maybe<Array<{ __typename?: 'MapLayerRtxData' } & MapLayerRtxDataFragment>>
    link: Maybe<Array<{ __typename?: 'MapLayerRtxData' } & MapLayerRtxDataFragment>>
    linkText: Maybe<Array<{ __typename?: 'MapLayerRtxData' } & MapLayerRtxDataFragment>>
    remoteImageUrl: Maybe<Array<{ __typename?: 'MapLayerRtxData' } & MapLayerRtxDataFragment>>
    rtx: Maybe<Array<{ __typename?: 'MapLayerRtxData' } & MapLayerRtxDataFragment>>
    videoStreamLink: Maybe<Array<{ __typename?: 'MapLayerRtxData' } & MapLayerRtxDataFragment>>
  }

export type ObjectFragment = { __typename?: 'Object' } & Pick<
  Object,
  'attachmentId' | 'entityId' | 'folderId' | 'id' | 'objectType' | 'title' | 'updatedAt'
> & {
    attachment: Maybe<{ __typename?: 'Attachment' } & AttachmentFragment>
    groupAccessList: Array<{ __typename?: 'UserGroup' } & UserGroupFragment>
    usersAccessList: Array<{ __typename?: 'User' } & UserFragment>
  }

export type OdataParamsFragment = { __typename?: 'OdataParams' } & Pick<
  OdataParams,
  'host' | 'pass' | 'port' | 'tables' | 'url' | 'user'
>

export type OlapAclFragment = { __typename?: 'OlapAcl' } & Pick<
  OlapAcl,
  'olapRequest' | 'panelsEdit' | 'panelsRead'
>

export type OlapChartLayerFragment = { __typename?: 'OlapChartLayer' } & Pick<
  OlapChartLayer,
  | 'chartType'
  | 'cubeId'
  | 'drillAsidePanelId'
  ...
  | 'width'
> & {
    analysis: Maybe<{ __typename?: 'Analysis' } & AnalysisFragment>
    chartProperties: Maybe<
      { __typename?: 'OlapLayerChartProperties' } & OlapLayerChartPropertiesFragment
    >
    columns: Maybe<Array<{ __typename?: 'OlapRequestField' } & OlapRequestFieldFragment>>
    havingFilters: Maybe<Array<{ __typename?: 'FormulaToken' } & FormulaTokenFragment>>
    hierarchy: Maybe<{ __typename?: 'OlapHierarchy' } & OlapHierarchyFragment>
    mapProperties: Maybe<{ __typename?: 'OlapLayerMapProperties' } & OlapLayerMapPropertiesFragment>
    rows: Maybe<Array<{ __typename?: 'OlapRequestField' } & OlapRequestFieldFragment>>
    sorting: Maybe<{ __typename?: 'OlapLayerSorting' } & OlapLayerSortingFragment>
    styles: Maybe<{ __typename?: 'OlapLayerStyles' } & OlapLayerStylesFragment>
    tableProperties: Maybe<
      { __typename?: 'OlapLayerTableProperties' } & OlapLayerTablePropertiesFragment
    >
    whereFilters: Maybe<Array<{ __typename?: 'FormulaToken' } & FormulaTokenFragment>>
  }

export type OlapDashboardFragment = { __typename?: 'OlapDashboard' } & Pick<
  OlapDashboard,
  | 'backgroundColor'
  | 'borderColor'
  | 'height'
  ...
  | 'workspace'
> & {
    analysis: Maybe<{ __typename?: 'DashboardAnalysis' } & DashboardAnalysisFragment>
    layers: Maybe<
      Array<
        | ({ __typename?: 'OlapChartLayer' } & OlapLayer_OlapChartLayer_Fragment)
        | ({ __typename?: 'OlapFilterLayer' } & OlapLayer_OlapFilterLayer_Fragment)
        | ({ __typename?: 'OlapTextLayer' } & OlapLayer_OlapTextLayer_Fragment)
      >
    >
    object: Maybe<{ __typename?: 'Object' } & ObjectFragment>
  }

export type OlapFilterLayerFragment = { __typename?: 'OlapFilterLayer' } & Pick<
  OlapFilterLayer,
  | 'applyToAllElement'
  | 'cubeId'
  ...
  | 'type'
  | 'width'
> & { filterField: Maybe<{ __typename?: 'OlapRequestField' } & OlapRequestFieldFragment> }

export type OlapHierarchyFragment = { __typename?: 'OlapHierarchy' } & Pick<OlapHierarchy, 'id'> & {
    fields: Maybe<Array<{ __typename?: 'OlapRequestField' } & OlapRequestFieldFragment>>
  }

type OlapLayer_OlapChartLayer_Fragment = { __typename?: 'OlapChartLayer' } & OlapChartLayerFragment

type OlapLayer_OlapFilterLayer_Fragment = {
  __typename?: 'OlapFilterLayer'
} & OlapFilterLayerFragment

type OlapLayer_OlapTextLayer_Fragment = { __typename?: 'OlapTextLayer' } & OlapTextLayerFragment

export type OlapLayerFragment =
  | OlapLayer_OlapChartLayer_Fragment
  | OlapLayer_OlapFilterLayer_Fragment
  | OlapLayer_OlapTextLayer_Fragment

export type OlapLayerAliasFragment = { __typename?: 'OlapLayerAlias' } & Pick<
  OlapLayerAlias,
  'alias' | 'fieldId' | 'hiddenAlias' | 'id' | 'name'
>

export type OlapLayerAxisFragment = { __typename?: 'OlapLayerAxis' } & Pick<
  OlapLayerAxis,
  'color' | 'gridColor' | 'isLog' | 'logBase'
> & {
    lineStyle: Maybe<{ __typename?: 'OlapLayerLineStyle' } & OlapLayerLineStyleFragment>
    textStyle: Maybe<{ __typename?: 'OlapLayerTextStyle' } & OlapLayerTextStyleFragment>
    x: Maybe<{ __typename?: 'OlapLayerDirectAxis' } & OlapLayerDirectAxisFragment>
    y: Maybe<{ __typename?: 'OlapLayerDirectAxis' } & OlapLayerDirectAxisFragment>
  }

export type OlapLayerBarFillStyleFragment = { __typename?: 'OlapLayerBarFillStyle' } & Pick<
  OlapLayerBarFillStyle,
  'color' | 'opacity'
>

export type OlapLayerChartPropertiesFragment = { __typename?: 'OlapLayerChartProperties' } & {
  sorting: Maybe<{ __typename?: 'OlapLayerSorting' } & OlapLayerSortingFragment>
}

export type OlapLayerDirectAxisFragment = { __typename?: 'OlapLayerDirectAxis' } & Pick<
  OlapLayerDirectAxis,
  'rotate' | 'withAxisLine' | 'withLabel' | 'withName'
>

export type OlapLayerGridFragment = { __typename?: 'OlapLayerGrid' } & Pick<
  OlapLayerGrid,
  'color' | 'type'
> & { lineStyle: Maybe<{ __typename?: 'OlapLayerLineStyle' } & OlapLayerLineStyleFragment> }

export type OlapLayerLegendFragment = { __typename?: 'OlapLayerLegend' } & Pick<
  OlapLayerLegend,
  'direction' | 'linesCount' | 'position' | 'show'
>

export type OlapLayerLineStyleFragment = { __typename?: 'OlapLayerLineStyle' } & Pick<
  OlapLayerLineStyle,
  'color' | 'opacity' | 'type' | 'width'
>

export type OlapLayerMapFragment = { __typename?: 'OlapLayerMap' } & Pick<OlapLayerMap, 'color'> & {
    marks: Maybe<Array<{ __typename?: 'OlapLayerMark' } & OlapLayerMarkFragment>>
    ranges: Maybe<Array<{ __typename?: 'OlapLayerRanges' } & OlapLayerRangesFragment>>
    tooltip: Maybe<{ __typename?: 'OlapLayerTooltip' } & OlapLayerTooltipFragment>
  }

export type OlapLayerMapPropertiesFragment = { __typename?: 'OlapLayerMapProperties' } & Pick<
  OlapLayerMapProperties,
  'center' | 'tile' | 'zoom'
>

export type OlapLayerMarkFragment = { __typename?: 'OlapLayerMark' } & Pick<
  OlapLayerMark,
  'color' | 'position' | 'showLine' | 'type' | 'value'
> & {
    filters: Maybe<Array<{ __typename?: 'OlapLayerMarkFilter' } & OlapLayerMarkFilterFragment>>
    rtx: Maybe<Array<{ __typename?: 'OlapLayerRtxData' } & OlapLayerRtxDataFragment>>
  }

export type OlapLayerMarkFilterFragment = { __typename?: 'OlapLayerMarkFilter' } & Pick<
  OlapLayerMarkFilter,
  'measuresIds'
> & {
    dimensions: Maybe<
      Array<{ __typename?: 'OlapLayerMarkFilterDimension' } & OlapLayerMarkFilterDimensionFragment>
    >
  }
...
export type OlapLayerMarkLineFragment = { __typename?: 'OlapLayerMarkLine' } & Pick<
  OlapLayerMarkLine,
  'category' | 'color' | 'label' | 'position' | 'type' | 'value'
>

export type OlapLayerPieFragment = { __typename?: 'OlapLayerPie' } & Pick<
  OlapLayerPie,
  'id' | 'innerRadius'
>

export type OlapLayerPointFragment = { __typename?: 'OlapLayerPoint' } & Pick<
  OlapLayerPoint,
  'id'
> & {
    barFill: Maybe<{ __typename?: 'OlapLayerBarFillStyle' } & OlapLayerBarFillStyleFragment>
    barStroke: Maybe<{ __typename?: 'OlapLayerShapeStyle' } & OlapLayerShapeStyleFragment>
    fill: Maybe<{ __typename?: 'OlapLayerShapeStyle' } & OlapLayerShapeStyleFragment>
    marks: Maybe<Array<{ __typename?: 'OlapLayerMark' } & OlapLayerMarkFragment>>
    stroke: Maybe<{ __typename?: 'OlapLayerShapeStyle' } & OlapLayerShapeStyleFragment>
    tooltip: Maybe<{ __typename?: 'OlapLayerTooltip' } & OlapLayerTooltipFragment>
  }

export type OlapLayerRangesFragment = { __typename?: 'OlapLayerRanges' } & Pick<
  OlapLayerRanges,
  'color' | 'end' | 'start'
>

export type OlapLayerRtxDataFragment = { __typename?: 'OlapLayerRtxData' } & Pick<
  OlapLayerRtxData,
  'align' | 'type'
> & { children: Array<{ __typename?: 'OlapLayerRtxItem' } & OlapLayerRtxItemFragment> }

export type OlapLayerRtxItemFragment = { __typename?: 'OlapLayerRtxItem' } & Pick<
  OlapLayerRtxItem,
  'bold' | 'color' | 'fontSize' | 'italic' | 'linkPanelId' | 'text' | 'type' | 'value'
> & {
    children: Maybe<Array<{ __typename?: 'OlapLayerRtxItemChild' } & OlapLayerRtxItemChildFragment>>
    element: Maybe<{ __typename?: 'OlapChartLayer' } & RichTextInlineElementFragment>
  }

export type OlapLayerRtxItemChildFragment = { __typename?: 'OlapLayerRtxItemChild' } & Pick<
  OlapLayerRtxItemChild,
  'text'
>

export type OlapLayerSeriaFragment = { __typename?: 'OlapLayerSeria' } & Pick<
  OlapLayerSeria,
  | 'cumulative'
  | 'donutPadding'
  | 'donutWidth'
...
> & {
    lineStyle: Maybe<{ __typename?: 'OlapLayerLineStyle' } & OlapLayerLineStyleFragment>
    marks: Maybe<Array<{ __typename?: 'OlapLayerMark' } & OlapLayerMarkFragment>>
    pointStyle: Maybe<{ __typename?: 'OlapLayerPoint' } & OlapLayerPointFragment>
    tooltip: Maybe<{ __typename?: 'OlapLayerTooltip' } & OlapLayerTooltipFragment>
    trendLine: Maybe<{ __typename?: 'TrendLine' } & TrendLineFragment>
  }

export type OlapLayerShapeStyleFragment = { __typename?: 'OlapLayerShapeStyle' } & Pick<
  OlapLayerShapeStyle,
  'color' | 'opacity' | 'size'
>

export type OlapLayerSortingFragment = { __typename?: 'OlapLayerSorting' } & Pick<
  OlapLayerSorting,
  'asc' | 'type'
>

export type OlapLayerStylesFragment = { __typename?: 'OlapLayerStyles' } & Pick<
  OlapLayerStyles,
  'backgroundColor' | 'sortingType' | 'valueRounding'
> & {
    aliases: Maybe<Array<{ __typename?: 'OlapLayerAlias' } & OlapLayerAliasFragment>>
    axis: Maybe<{ __typename?: 'OlapLayerAxis' } & OlapLayerAxisFragment>
    grid: Maybe<{ __typename?: 'OlapLayerGrid' } & OlapLayerGridFragment>
    hGrid: Maybe<{ __typename?: 'OlapLayerVHGrid' } & OlapLayerVhGridFragment>
    legend: Maybe<{ __typename?: 'OlapLayerLegend' } & OlapLayerLegendFragment>
    map: Maybe<{ __typename?: 'OlapLayerMap' } & OlapLayerMapFragment>
    markLines: Maybe<Array<{ __typename?: 'OlapLayerMarkLine' } & OlapLayerMarkLineFragment>>
    pie: Maybe<{ __typename?: 'OlapLayerPie' } & OlapLayerPieFragment>
    points: Maybe<Array<{ __typename?: 'OlapLayerPoint' } & OlapLayerPointFragment>>
    series: Maybe<Array<{ __typename?: 'OlapLayerSeria' } & OlapLayerSeriaFragment>>
    seriesConfig: Maybe<{ __typename?: 'OlapLayerSeria' } & OlapLayerSeriaFragment>
    table: Maybe<{ __typename?: 'OlapLayerTable' } & OlapLayerTableFragment>
    vGrid: Maybe<{ __typename?: 'OlapLayerVHGrid' } & OlapLayerVhGridFragment>
    zooming: Maybe<{ __typename?: 'OlapLayerZooming' } & OlapLayerZoomingFragment>
  }

export type OlapLayerTableFragment = { __typename?: 'OlapLayerTable' } & Pick<
  OlapLayerTable,
  'horizontalPadding' | 'id' | 'mergeCells' | 'stickyHeader' | 'stickySide' | 'verticalPadding'
> & {
    columnWidths: Maybe<Array<{ __typename?: 'TablePartSize' } & TablePartSizeFragment>>
    rowLines: Maybe<Array<{ __typename?: 'TablePartSize' } & TablePartSizeFragment>>
  }

export type OlapLayerTablePropertiesFragment = { __typename?: 'OlapLayerTableProperties' } & Pick<
  OlapLayerTableProperties,
  'showTotal'
>

export type OlapLayerTextStyleFragment = { __typename?: 'OlapLayerTextStyle' } & Pick<
  OlapLayerTextStyle,
  'color' | 'fontSize'
>

export type OlapLayerTooltipFragment = { __typename?: 'OlapLayerTooltip' } & Pick<
  OlapLayerTooltip,
  'color' | 'position' | 'type'
> & {
    filters: Maybe<Array<{ __typename?: 'OlapLayerMarkFilter' } & OlapLayerMarkFilterFragment>>
...
export type OlapLayerVhGridFragment = { __typename?: 'OlapLayerVHGrid' } & Pick<
  OlapLayerVhGrid,
  'areas' | 'show'
>

export type OlapLayerZoomingFragment = { __typename?: 'OlapLayerZooming' } & {
  horizontal: Maybe<{ __typename?: 'OlapLayerZoomingOpts' } & OlapLayerZoomingOptsFragment>
  vertical: Maybe<{ __typename?: 'OlapLayerZoomingOpts' } & OlapLayerZoomingOptsFragment>
}

export type OlapLayerZoomingOptsFragment = { __typename?: 'OlapLayerZoomingOpts' } & Pick<
  OlapLayerZoomingOpts,
  'enabled' | 'end' | 'start'
>

export type OlapRequestArgFragment = { __typename?: 'OlapRequestArg' } & Pick<
  OlapRequestArg,
  'columnId' | 'cubeId' | 'dataType' | 'dateFormat' | 'label' | 'type' | 'value'
>

export type OlapRequestFieldFragment = { __typename?: 'OlapRequestField' } & Pick<
  OlapRequestField,
  'agg' | 'hierarchyId' | 'id' | 'index' | 'name' | 'showTotal' | 'valueRounding'
> & {
    additionalCalc: Maybe<{ __typename?: 'AdditionalCalc' } & AdditionalCalcFragment>
    args: Maybe<Array<{ __typename?: 'OlapRequestArg' } & OlapRequestArgFragment>>
    calculatedFormula: Maybe<Array<{ __typename?: 'FormulaToken' } & FormulaTokenFragment>>
  }

export type OlapResponseFragment = { __typename?: 'OlapResponse' } & Pick<OlapResponse, 'data'>

export type OlapTextLayerFragment = { __typename?: 'OlapTextLayer' } & Pick<
  OlapTextLayer,
  | 'color'
  | 'fontStyle'
  | 'fontWeight'
...
export type OrganisationFragment = { __typename?: 'Organisation' } & Pick<
  Organisation,
  'description' | 'email' | 'id' | 'name' | 'private' | 'url'
> & { acl: Maybe<{ __typename?: 'Acl' } & AclFragment> }

export type OseAclFragment = { __typename?: 'OseAcl' } & Pick<OseAcl, 'tablesEdit' | 'tablesRead'>

export type OutDbParamsFragment = { __typename?: 'OutDbParams' } & Pick<
  OutDbParams,
  'db' | 'dbType' | 'exportToDb' | 'host' | 'pass' | 'port' | 'tableName' | 'title' | 'user'
>

export type PmChecklistFragment = { __typename?: 'PmChecklist' } & Pick<
  PmChecklist,
  'description' | 'id' | 'insertedAt' | 'title' | 'updatedAt' | 'userIds'
> & { tasks: Maybe<Array<{ __typename?: 'PmChecklistTask' } & PmChecklistTaskFragment>> }

export type PmChecklistTaskFragment = { __typename?: 'PmChecklistTask' } & Pick<
  PmChecklistTask,
  'description' | 'id' | 'planFinishTime' | 'planStartTime' | 'status' | 'title' | 'userIds'
>

export type ProgressFragment = { __typename?: 'Progress' } & Pick<
  Progress,
  'allCount' | 'doneCount' | 'label'
>

export type ProjectManagementFragment = { __typename?: 'ProjectManagement' } & Pick<
  ProjectManagement,
  'id' | 'insertedAt' | 'title' | 'updatedAt'
> & {
    checklists: Maybe<Array<{ __typename?: 'PmChecklist' } & PmChecklistFragment>>
    object: Maybe<{ __typename?: 'Object' } & ObjectFragment>
  }

export type RegressionFragment = { __typename?: 'Regression' } & Pick<Regression, 'predictSize'> & {
    models: Maybe<Array<{ __typename?: 'RegressionModel' } & RegressionModelFragment>>
  }

export type RegressionModelFragment = { __typename?: 'RegressionModel' } & Pick<
  RegressionModel,
  'intercept' | 'predictId' | 'r2' | 'relevant' | 'seriaId' | 'significanceLevel'
> & { vars: Array<{ __typename?: 'RegressionVar' } & RegressionVarFragment> }

export type RegressionModelV1Fragment = { __typename?: 'RegressionModelV1' } & Pick<
  RegressionModelV1,
  'elementId' | 'intercept' | 'predictId' | 'r2' | 'relevant' | 'seriaId' | 'significanceLevel'
> & { vars: Array<{ __typename?: 'RegressionVarV1' } & RegressionVarV1Fragment> }

export type RegressionVarFragment = { __typename?: 'RegressionVar' } & Pick<
  RegressionVar,
  'coef' | 'coefMax' | 'coefMin' | 'func' | 'lagsCount' | 'relevant' | 'seriaId'
>

export type RegressionVarV1Fragment = { __typename?: 'RegressionVarV1' } & Pick<
  RegressionVarV1,
  | 'agg'
  | 'coef'
  | 'coefMax'
...
export type RestHttpAnswerFragment = { __typename?: 'RestHttpAnswer' } & Pick<
  RestHttpAnswer,
  'body' | 'code'
>

export type RestParamsFragment = { __typename?: 'RestParams' } & Pick<
  RestParams,
  | 'apiKeyName'
  | 'apiKeyValue'
  | 'authMode'
  ...
  | 'url'
> & {
    endpoints: Maybe<Array<{ __typename?: 'RestParamsEndpoint' } & RestParamsEndpointFragment>>
    headers: Maybe<Array<{ __typename?: 'RestParamsHeader' } & RestParamsHeaderFragment>>
  }

export type RestParamsEndpointFragment = { __typename?: 'RestParamsEndpoint' } & Pick<
  RestParamsEndpoint,
  | 'args'
  | 'dateLimitType'
  | 'id'
...
export type RestParamsHeaderFragment = { __typename?: 'RestParamsHeader' } & Pick<
  RestParamsHeader,
  'name' | 'value'
>
...
export type RoleFragment = { __typename?: 'Role' } & Pick<
  ...
  | 'title'
> & {
    externalSystems: Array<{ __typename?: 'ExternalSystem' } & ExternalSystemFragment>
    users: Array<{ __typename?: 'User' } & UserFragment>
  }

export type SessionFragment = { __typename?: 'Session' } & Pick<
  Session,
  'expireAt' | 'refreshToken' | 'token'
> & { user: { __typename?: 'User' } & UserFragment }

export type SharedAclFragment = { __typename?: 'SharedAcl' } & Pick<
  SharedAcl,
  'foldersEdit' | 'foldersRead' | 'objectsEdit' | 'objectsRead' | 'organisationCreate'
>

type SocketMessage_StepProgress_Fragment = { __typename?: 'StepProgress' } & StepProgressFragment
...
type SocketMessage_ChatOnline_Fragment = { __typename?: 'ChatOnline' } & ChatOnlineFragment

type SocketMessage_ChatUser_Fragment = { __typename?: 'ChatUser' } & ChatUserFragment

type SocketMessage_ChatMessage_Fragment = { __typename?: 'ChatMessage' } & ChatMessageFragment

type SocketMessage_ChatRoom_Fragment = { __typename?: 'ChatRoom' } & ChatRoomFragment

export type SocketMessageFragment =
  | SocketMessage_StepProgress_Fragment
  | SocketMessage_DatasourceState_Fragment
  | SocketMessage_DatasourceProgress_Fragment
  | SocketMessage_ChatOnline_Fragment
  | SocketMessage_ChatUser_Fragment
  | SocketMessage_ChatMessage_Fragment
  | SocketMessage_ChatRoom_Fragment

export type StepFragment = { __typename?: 'Step' } & Pick<
  Step,
  | 'columnsCount'
  | 'dateColumn'
  | 'dupColumnsCount'
  ...
  | 'updatedAt'
> & {
    changes: Array<{ __typename?: 'Change' } & ChangeFragment>
    datasource: Maybe<{ __typename?: 'Datasource' } & DatasourceFragment>
    flow: Maybe<{ __typename?: 'Flow' } & FlowFragment>
    leftColumns: Maybe<Array<{ __typename?: 'Column' } & ColumnFragment>>
    outDbParams: Maybe<Array<{ __typename?: 'OutDbParams' } & OutDbParamsFragment>>
    rightColumns: Maybe<Array<{ __typename?: 'Column' } & ColumnFragment>>
    whereCond: Maybe<Array<{ __typename?: 'FormulaToken' } & FormulaTokenFragment>>
  }

export type StepProgressFragment = { __typename?: 'StepProgress' } & Pick<
  StepProgress,
  'status' | 'stepId'
> & { processes: Maybe<Array<{ __typename?: 'Progress' } & ProgressFragment>> }

export type TableFragment = { __typename?: 'Table' } & Pick<
  Table,
  | 'cubeDescription'
  | 'cubeTitle'
  | 'description'
  ...
  | 'updatedAt'
> & {
    connections: Maybe<Array<{ __typename?: 'Connection' } & ConnectionFragment>>
    fields: Maybe<Array<{ __typename?: 'Field' } & FieldFragment>>
    hierarchies: Maybe<Array<{ __typename?: 'Hierarchy' } & HierarchyFragment>>
    object: Maybe<{ __typename?: 'Object' } & ObjectFragment>
  }

export type TablePartSizeFragment = { __typename?: 'TablePartSize' } & Pick<
  TablePartSize,
  'id' | 'value'
>

export type TreeFragment = { __typename?: 'Tree' } & {
  folders: Array<{ __typename?: 'Folder' } & FolderFragment>
  objects: Array<{ __typename?: 'Object' } & ObjectFragment>
}

export type TreesFragment = { __typename?: 'Trees' } & {
  pinnedTree: { __typename?: 'Tree' } & TreeFragment
  tree: { __typename?: 'Tree' } & TreeFragment
}

export type TrendLineFragment = { __typename?: 'TrendLine' } & Pick<TrendLine, 'color' | 'opacity'>

export type UserFragment = { __typename?: 'User' } & Pick<
  User,
  'avatar' | 'email' | 'firstName' | 'id' | 'lastName' | 'name' | 'orgQuota' | 'status'
> & { acl: Maybe<{ __typename?: 'Acl' } & AclFragment> }

export type UserGroupFragment = { __typename?: 'UserGroup' } & Pick<
  UserGroup,
  'description' | 'folderId' | 'id' | 'title'
> & {
    cubeFilters: Array<{ __typename?: 'CubeFilter' } & CubeFilterFragment>
    externalSystems: Array<{ __typename?: 'ExternalSystem' } & ExternalSystemFragment>
