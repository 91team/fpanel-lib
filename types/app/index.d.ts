...
declare namespace App {
  ...
  > = {
    ...
    setState?: TSetState
    notifications?: {
      [key in Data.TNotification['type']]?: Omit<Data.TNotification, 'id' | 'type'>
    }
  }
  type TGraphqlAction<TGraphqlResult extends MutationResult | QueryResult, TParams extends {}> = (
  ...
  type TGraphqlConfig = Pick<TCreateGraphqlActionParams, 'GQLDocument' | 'notifications'>
